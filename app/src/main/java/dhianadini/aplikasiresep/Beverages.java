...
public class Beverages extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchfeedback = new Intent(Beverages.this, Feedback.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_food) {
            Intent intent = new Intent(Beverages.this, Food.class);
            startActivity(intent);
        } else if (id == R.id.nav_bev) {
            Intent intent = new Intent(Beverages.this, Beverages.class);
            startActivity(intent);
        } else if (id == R.id.nav_dessert) {
            Intent intent = new Intent(Beverages.this, Dessert.class);
            startActivity(intent);
